...
// Pruebas unitarias para ProblemaMapper
class ProblemaMapperTest {
    ...
    void toEntity_deDtoAEntidad() {
        ...
        // Entonces: los campos simples deben mapearse, idProblema y espacio quedan nulos
    ...
    void toResponse_deEntidadADto() {
        // Dado: una entidad Problema con relación a Espacio
        Date fecha = Date.valueOf("2025-05-20");
        ...
        // Entonces: los campos deben copiarse correctamente, incluyendo espacioId
    ...
    void updateFromDto_actualizaCampos() {
        ...
        // Entonces: idProblema y espacio no cambian, solo los campos editables
